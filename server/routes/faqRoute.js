...
import { getFaqs, getSingleFaq, createFaq, updateFaq} from "../controllers/faqController.js";
...
router.route("/faq/:id").put(isAuthenticated, authorizeRole('admin'), updateFaq);
